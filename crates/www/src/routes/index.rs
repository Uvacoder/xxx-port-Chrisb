...
fn BentoBox<'a>(
    ...
    view! {
        <div
            ...
            class="bento-container h-full"
        >
        <div
            style=style
            class="bento-box h-full"
        >
        {
    ...
    view! {
            ...
            children=move |(index, content)| {
              view! {
                ...
                class=format!(
                    "row-span-1 {}",
                    // "row-span-1 rounded-xl border-2 border-slate-400/10 bg-neutral-100 p-4 dark:bg-ctp-surface0 min-h-full {}",
                    if index == 3 || index == 6 {
                        "col-span-2"
                    } else {
                        ""
                 ...
                 >
                    ...
                    >
                         <p class=format!("text-2xl font-bold leading-7 text-ctp-text sm:truncate sm:text-3xl sm:tracking-tight {}",
                         if content.center_title {
                            "text-center"
                         } else {
                            ""
                         }
    ...
    >
      <div class="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
        ...
        <p class="mt-6 text-xl text-indigo-100 max-w-3xl">
            ...
            JavaScript, and occassionally other languages.

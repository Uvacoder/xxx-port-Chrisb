            ...
            <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-slate-900 px-6 ring-1 ring-white/10">
              ...
              <nav class="flex flex-1 flex-col">
                <ul role="list" class="flex flex-1 flex-col gap-y-7">
                  ...
                  <li>
                    <div class="text-xs font-semibold leading-6 text-slate-400">Shortcuts</div>
                    ...
                    children=move |item| {
                      ...
                      <li>
                        {/* Current: "bg-slate-800 text-white", Default: "text-slate-400 hover:text-white hover:bg-slate-800" */}
                        <a href={item.url} class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-slate-400 hover:bg-slate-800 hover:text-white">
                          <span class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border border-slate-700 bg-slate-800 text-[0.625rem] font-medium text-slate-400 group-hover:text-white">{item.shortcode}</span>
                  ...
                  <li class="-mx-6 mt-auto">
                    <a href="#" class="flex items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-white hover:bg-slate-800">
                      <img class="h-6 w-6 rounded-full bg-slate-800" src="/logos/logo-circle.svg" alt=""/>
        ...
        <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-slate-950/10 px-6 ring-1 ring-white/5">
          ...
          <nav class="flex flex-1 flex-col">
            <ul role="list" class="flex flex-1 flex-col gap-y-7">
              <li>
                <ul role="list" class="-mx-2 space-y-1">
                  <li>
                    {/* Current: "bg-slate-800 text-white", Default: "text-slate-400 hover:text-white hover:bg-slate-800" */}
                    <a href="/garden" class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-slate-400 hover:bg-slate-800 hover:text-white">
                    <svg class="h-6 w-6 shrink-0 text-green-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor"><path d="M223.45,40.07a8,8,0,0,0-7.52-7.52C139.8,28.08,78.82,51,52.82,94a87.09,87.09,0,0,0-12.76,49c.57,15.92,5.21,32,13.79,47.85l-19.51,19.5a8,8,0,0,0,11.32,11.32l19.5-19.51C81,210.73,97.09,215.37,113,215.94q1.67.06,3.33.06A86.93,86.93,0,0,0,162,203.18C205,177.18,227.93,116.21,223.45,40.07ZM153.75,189.5c-22.75,13.78-49.68,14-76.71.77l88.63-88.62a8,8,0,0,0-11.32-11.32L65.73,179c-13.19-27-13-54,.77-76.71,22.09-36.47,74.6-56.44,141.31-54.06C210.2,114.89,190.22,167.41,153.75,189.5Z"/></svg>
                      garden
                    </a>
                  </li>
              ...
              <li class="-mx-6 mt-auto">
                <a href="#" class="flex items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-white hover:bg-slate-800">
                  <img class="h-8 w-8 rounded-full bg-slate-800" src="/logos/logo-circle.svg" alt=""/>
                  <span class="sr-only">Links</span>
                  <span aria-hidden="true">@chrisbiscardi</span>
                </a>
              </li>
          ...
          <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            <form class="flex flex-1" action="#" method="GET">
              ...
              <div class="relative w-full">
                <svg class="pointer-events-none absolute inset-y-0 left-0 h-full w-5 text-slate-500" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
